 ...
 */**
 * PRINCIPE DEL PACIFICO — Beds24 Booking URL Builder
 * js/booking.js  |  Version 2.0 — March 2026
 *
 * Usage on apartment detail pages:
 *   bookNow('master')   // opens Beds24 with pre-filled params
 *   buildBookingUrl({ apartmentId: 'white', checkin: '2026-04-05', checkout: '2026-04-08', adults: 2 })
 */
 ...
 * DO NOT change without verifying in Beds24 control panel.
 */
const ENQUIRE_IDS = {
  white:  '405215',
  master: '405247',
...
/**
 * Build a Beds24 booking URL with pre-filled parameters.
 * @param {Object} params
...
/**
 * Read search params from current page URL.
 * Useful in detail pages to pre-fill checkin/checkout from homepage search.
 */
...
/**
 * Open Beds24 in a new tab with correct params.
 * Called from "Book now" buttons on detail pages.
